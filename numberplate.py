...
class ContourWithData():
	...
	def checkIfContourIsValid(self):                            # contour selection
		...
		if ratio >= 2  and ratio <= 4 and (self.fltArea > MIN_CONTOUR_AREA and self.fltArea < MAX_CONTOUR_AREA) : return True        # much better validity checking would be necessary
		return False 
